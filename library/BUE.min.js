...
c)};e.browseButton=function(a,c,d){var f=this.settings;if(f=f[c+"Browser"]||f.fileBrowser)return b.browseButton(f,a,c,d)};b.eToolbarKeydown=function(a){var c,d,f;c=g.event.fix(a||n.event);a=c.keyCode;if(!(c.ctrlKey||c.shiftKey||c.altKey||37!==a&&39!==a)){d=g(".bue-button",this).filter(":visible");if(f=d.length)c=d.index(h.activeElement),d.eq((f+c+a-38)%f).focus();return!1}if(9!==a&&13!==a&&32!==a)return b.eFireShortcut.call(this,c)};b.eToolbarMousedown=function(a){this===b.eTarget(a)&&b.editorOf(this).focus();
return!1};b.eTwMousedown=function(a){if(this===b.eTarget(a))return b.editorOf(this).focus(),!1};b.eFireShortcut=function(a){var c;if((a=b.eBuildShortcut(a))&&(c=b.editorOf(this))&&c.fireShortcut(a))return!1};b.eTarget=function(a){a||(a=n.event);return a.target||a.srcElement};b.editorOf=function(a){return a.bueEid?b.getEditor(a.bueEid):!1};b.runEditorBuilders=function(a){b.buildEditorPopups(a);b.buildEditorButtons(a);b.buildEditorPreview(a);b.buildEditorHistory(a);b.buildEditorAc(a);b.buildEditorIndent(a);
for(var c in b.builders)b.builders[c](a)};e.posSelection=e.getRange;e.makeSelection=e.setRange;e.replaceSelection=e.setSelection;e.tagSelection=e.wrapSelection;b.buildEditorAc=function(a){a.ac={};a.bind("destroy",b.destroyEditorAc);a.bind("controlTextarea",b.acControlTextarea);a.settings.acTags&&a.addAc(">",b.acHtmlTags)};b.destroyEditorAc=function(a){delete a.ac};b.acControlTextarea=function(a,c){g(c).bind("keypress.bue",b.eAcTextareaKeypress)};b.eAcTextareaKeypress=function(a){if(!a.isDefaultPrevented()){var c=
